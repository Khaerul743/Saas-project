...
from app.schema.agent_schema import BaseAgentSchema
...
class AgentController(BaseController):
    ...
    def _get_current_user_id(self, current_user_jwt: Optional[dict] = None, current_user_context: Optional[dict] = None):
        current_user_id = current_user_context.get("id") if current_user_context else current_user_jwt.get("id") if current_user_jwt else None

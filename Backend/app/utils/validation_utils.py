...
def validate_agent_exists_and_owned(
    db: Session, agent_id: str, user_id: int, user_email: str
) -> Agent:
    """
...
async def validate_user_exists_async(
    db: AsyncSession, user_id: int, user_email: Optional[str]
) -> User:
    """
